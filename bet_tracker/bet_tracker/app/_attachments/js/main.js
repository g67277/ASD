...
$('#home').on('pageinit', function () {
    ...
    $('#groupA').click(function () {
        $.ajax({
            url: 'http://127.0.0.1:5984/bets/_design/app/_view/group_a',
            type: 'GET',
            dataType: 'json',
    ...
    $('#groupB').click(function () {
        $.ajax({
            url: 'http://127.0.0.1:5984/bets/_design/app/_view/group_b',
            type: 'GET',
            dataType: 'json',
            success: function (response) {
                $.each(response.rows, function (index, groupA) {
...
$('#bets').on('pageinit', function () {
    ...
    function autoFill() {
        ...
        $.ajax({
            url: 'http://127.0.0.1:5984/bets/_design/app/_view/bets',
            type: 'GET',
            dataType: 'json',
